...
public class PedidoPage {
    ...
    private By texto_pedidoConfirmado = By.cssSelector("#content-hook_order_confirmation h3");
    ...
    public String obter_textoPedidoConfirmado(){
        return driver.findElement(texto_pedidoConfirmado).getText();
    ...
    public String obter_metodoPagamento(){
        return Funcoes.removeTexto(driver.findElement(metodoPagamento).getText(), "Payment method: ");
    }
